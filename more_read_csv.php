...
// 	$CSVfp2 = fopen("mycsv.csv", "r");
// 	$tmp = fopen("tempuse.csv", "w");
// 	$checkers = $_POST["checkboxes"];
// 	$data2 = getcsv($CSVfp2, 1000, ",");
// 	if ($checkers[$data2[0]]) {
// 		fputcsv($tmp, $data2);
// 	}
// 	fclose($CSVfp2);
// 	fclose($tmp);
// 	header("Location: select_write_out.php"); 
// 	die("bad write out");
// }
/*
